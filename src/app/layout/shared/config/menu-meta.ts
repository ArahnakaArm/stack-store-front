...
const MENU_ITEMS_COMMON: MenuItem[] = [
    ...
    /*    { key: 'system-management', label: 'ตั้งค่าระบบ', isTitle: true },
       {
           key: 'user-management',
...
export {MENU_ITEMS_COMMON, MENU_ITEMS, TWO_COl_MENU_ITEMS, HORIZONTAL_MENU_ITEMS };