...
import { MENU_ITEMS_COMMON } from '../config/menu-meta';
...
export class LeftSidebarComponent implements OnInit, AfterViewInit {
  ...
  initMenu(): void {
    ...
    if (this.loggedInUser.user_type_id === 'GEN_USER' ) {
      this.menuItems = MENU_ITEMS_COMMON;
    } else {
  ...
  _activateMenu(): void {
    ...
    let matchingMenuItem = null as any;
